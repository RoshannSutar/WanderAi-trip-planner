    ...
    return (
        <div className='container mx-auto my-12'>
            <div className='mx-[150px]'>
                <h2 className='font-bold text-3xl text-left'>Tell us your travel preferences 🏕️🏖️</h2>
                <p className='text-gray-500 mt-4'>Simply input your destination, number of travelers, and budget, and let our smart algorithm craft a personalized trip plan just for you.  
                    Say goodbye to the stress of planning and hello to the joy of discovering your next adventure effortlessly!</p>
                <div className='mt-7 flex flex-col gap-10'>
                    <div className='mt-5'>
                        <h2 className='text-xl my-3 font-medium text-left'>What is your destination choice?</h2>
                    ...
                    <div>
                        <h2 className='text-xl my-3 font-medium text-left'>How many days are you planning?</h2>
                        <Input
                            placeholder='Ex. 3'
                            type="number"
                    ...
                    <div>
                        <h2 className='text-xl my-3 font-medium text-left'>What is your travel style?</h2>
                        <div className='grid grid-cols-3 gap-4'>
                ...
                <div className='mt-20 mb-15 text-right'>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogDescription>
                                ...
                                <Button 
                                disabled={loading}
                                onClick={login} className='mt-6 w-full'>
